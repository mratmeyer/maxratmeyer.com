...
![Performance test with Worker fetching straight from S3.]({{ static.prefix }}media/workers-fetch-origin.jpg "Performance test with Worker fetching straight from S3.")
...
![Performance test with Worker fetching from Workers KV]({{ static.prefix }}media/workers-fetch-kv.jpg "Performance test with Worker fetching from Workers KV")
...
![Performance test with Worker fetching from node cache]({{ static.prefix }}media/workers-fetch-node.jpg "Performance test with Worker fetching from node cache")
...
![Example Workers Settings Page]({{ static.prefix }}media/workers-settings.jpg "Example Workers Settings Page")
...
![Example Workers Domain Settings Page]({{ static.prefix }}media/workers-domain-settings.jpg "Example Workers Domain Settings Page")
