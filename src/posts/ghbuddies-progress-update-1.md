...
{% Image "./src/assets/media/ghbuddies-web-screenshot.jpg", "Original GHBuddies Web App", "" %}
...
{% Image "./src/assets/media/ghbuddies-notification-screenshot.jpg", "GHBuddies Notification", "" %}
...
{% Image "./src/assets/media/ghbuddies-ios-1.jpg", "GHBuddies Login Screen", "" %}
...
{% Image "./src/assets/media/ghbuddies-ios-2.jpg", "Beta GHBuddies Home Screen", "" %}
