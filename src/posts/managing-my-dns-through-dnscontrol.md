...
![DNSControl Records for one of my domains]({{ static.prefix }}media/dnscontrol-records.jpg "DNSControl Records for one of my domains")
...
![Using loops to repeat records for multiple domains]({{ static.prefix }}media/dnscontrol-repeat-records.jpg "Using loops to repeat records for multiple domains")
